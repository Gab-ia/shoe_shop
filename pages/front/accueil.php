...
<head>
    ...
    <link rel="stylesheet" href="/shoe_shop/css/style2.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <script type="text/javascript" src='/shoe_shop/js/accueil.js'> </script>
...
<body>
    <header>
        <div class="svg">
            ...
            <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="px" y="0px" viewBox="0 0 300 162" width="250px"
                height="118px" class="size-logo">
        ...
        <div>
            <ul>
                <li><a href="" class="lien" style="text-decoration:none; color:var(--couleur-1);"
                        onclick="afficheMenu()">HOMME</a></li>
                <li><a href="" class="lien" style="text-decoration:none; color:var(--couleur-1);"
                        onclick="afficheMenu()">FEMME</a></li>
                <li><a href="" class="lien" style="text-decoration:none; color:var(--couleur-1);"
                        onclick="afficheMenu()">ENFANT</a></li>
            </ul>
    ...
    <footer>
        ...
        <div class="copyright">
            ...
            <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="px" y="0px" viewBox="0 0 300 162" width="100px"
                height="58px" class="size-logo">
                <path class="couleur-logo"
                    d="M90,85.9l29.2-78.6H99.9L86.5,41.4l3-34.1H69.2L40.1,85.9h18.8l14.3-38.1l-2.5,37.1L90,85.9z M112.7,85.9
            l29.2-78.6h-18.3L93.9,85.9H112.7z M165.6,81l-1-39.5l27.7-32.1L165.6,81z M300,53.3l-93.9,24.2l2.5-7.4h-19.8l6.4-18.8H212L217,37
            l-16.8,1l5.9-15.8h16.3l5.4-14.3H175l-19.3,22.7l9.4-23.2h-18.8l-29.2,78.6h19.3l12.4-33.6v33.6h24.7L85,109.1
