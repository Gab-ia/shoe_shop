  ...
  <section class="connexion_client_section">
    ...
    <form class="connexion_client_form">
      ...
      <div style="padding: 10px 0; display: flex; gap: 10px;">
        ...
        <div>
          <input type="prenom" id="prenom" name="prenom" placeholder="Prénom" required>
        </div>
      </div>

      <div>
        <input type="id" id="identifiant" name="identifiant" placeholder="Identifiant" required>
      </div>
      ...
      <p class="connexion_client_creercompte">J'ai déjà un compte, <a href="/">se connecter</a>
      </p>
